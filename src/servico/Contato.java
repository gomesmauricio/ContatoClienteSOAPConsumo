...
public class Contato  implements java.io.Serializable {
    ...
    /**
     * Gets the fone value for this Contato.
     * 
     * @return fone
     */
    ...
    /**
     * Sets the fone value for this Contato.
     * 
     * @param fone
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://servico/", "contato"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("", "fone"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
